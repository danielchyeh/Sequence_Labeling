...
model.add(Conv1D(input_shape=(777, 39), filters=150, kernel_size=7,use_bias=False, padding='causal',activation='relu'))
##model.add(MaxPooling1D(pool_size=1))
model.add(Dropout(0.2))
#model.add(BatchNormalization())
#
model.add(Conv1D(filters=150, kernel_size=7,use_bias=False, padding='causal',activation='relu'))
##model.add(MaxPooling1D(pool_size=1))
model.add(Dropout(0.2))
#model.add(BatchNormalization())
#
...
#
#
model.save('my_model1027cnn3.h5')  # creates a HDF5 file 'my_model.h5'
